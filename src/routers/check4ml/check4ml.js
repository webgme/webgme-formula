...
/**
 * Generated by RestRouterGenerator 2.2.0 from webgme on Fri May 05 2017 16:30:26 GMT-0500 (Central Daylight Time).
 ...
 * gmeConfig.rest.component['path/subPath'] = path.join(process.cwd(), './check4ml')
...
var express = require('express'),
    ...
    mongoose = requireJS('src4ml/src/db/mongoose'),
    config4ml = require('./../../config/config.json'),
    dbApi = null;
...
function initialize(middlewareOpts) {
    var logger = middlewareOpts.logger.fork('check4ml'),
