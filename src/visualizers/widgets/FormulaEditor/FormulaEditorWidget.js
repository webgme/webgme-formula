...
define(['css!./styles/FormulaEditorWidget.css'], function () {
    'use strict';
    ...
    FormulaEditorWidget.prototype._initialize = function () {
        ...
        this._el.append('<h3>FormulaEditor Events:</h3>');
    ...
    FormulaEditorWidget.prototype.addNode = function (desc) {
        if (desc) {
    ...
    FormulaEditorWidget.prototype.removeNode = function (gmeId) {
        var desc = this.nodes[gmeId];
        this._el.append('<div>Removing node "' + desc.name + '"</div>');
        delete this.nodes[gmeId];
    };

    FormulaEditorWidget.prototype.updateNode = function (desc) {
        if (desc) {
    ...
    FormulaEditorWidget.prototype.onNodeClick = function (/*id*/) {
        // This currently changes the active node to the given id and
        // this is overridden in the controller.
    };

    FormulaEditorWidget.prototype.onBackgroundDblClick = function () {
